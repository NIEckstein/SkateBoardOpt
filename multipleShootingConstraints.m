function [Cineq, Ceq] = multipleShootingConstraints(decisionVars,Param)
    ...
    noFallCons= -[ry_knee; ry_hip; ry_front_torso; ry_back_torso; ry_head];
    ...
    dtdurCon = Param.tdurLB-tdur;

    % torque limits

    tauLims= [taugrid-Param.tauLim; -Param.tauLim-taugrid];
    tauLims = reshape(tauLims, [], 1);
    ...
    slackVarCons=[slackVarCons; reshape(slackVars(1:2,1),[],1)];
    ...
    VelCon= (y(end)-y(1))/tdur - Param.avgVel;

    % form the return vars
    Cineq = [noFallCons; dhCon; RoMCons; tauLims; dtdurCon];
